...
std::unique_ptr<Shader> ShaderFactory::FromFiles(const std::string &vertexPath, const std::string &fragmentPath)
{
...
std::unique_ptr<Shader> ShaderFactory::FromMemory(const std::string &vertexSrc, const std::string &fragmentSrc)
{
    auto shader = std::make_unique<Shader>();
